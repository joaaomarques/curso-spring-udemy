...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Eltrônicos");
		...
		Cliente cli1 = new Cliente(null, "Maria", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, passwordenconder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "João", "curso.spring.udemy@gmail.com", "73171577089", TipoCliente.PESSOAFISICA, passwordenconder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("33454647", "93323435"));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 108", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida 4", "108", "Apto 300", "Cabula", "450350031", cli2, c2);
